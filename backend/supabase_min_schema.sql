...
--                 lightweight text URLs like avatar_url — nothing heavy).
--   TRANSITIONAL: posts / clubs / communities / organizations / schools /
--                 club_books / book_chapters keep the app fully working TODAY.
--                 After the MongoDB cutover (edge API serves feed + library)
--                 you can DROP the transitional tables marked below.
-- ============================================================================
